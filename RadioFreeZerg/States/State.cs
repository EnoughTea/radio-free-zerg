...
namespace RadioFreeZerg.States
{
    ...
    public abstract class State<TStateId, TStateData, TStateEvent> where TStateId : struct
    {
        ...
        /// <summary>
        ///     Handles event with the given name and returns ID of the next state.
        ///     default(TStateId) means no transition.
        /// </summary>
        /// <param name="data">State data.</param>
        ...
        public virtual TStateId HandleEvent(TStateEvent stateEvent, TStateData data) => default;
    }
}